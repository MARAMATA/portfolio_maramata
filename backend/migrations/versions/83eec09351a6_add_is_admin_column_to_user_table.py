...
Revision ID: 83eec09351a6
Revises: 
Create Date: 2025-03-02 20:49:39.824174
...
def upgrade() -> None:
    ...
    op.drop_table('portfolio_blogpost')
    ...
    op.drop_table('portfolio_contactmessage')
...
def downgrade() -> None:
    ...
    op.create_table('portfolio_contactmessage',
    ...
    sa.PrimaryKeyConstraint('id', name='portfolio_contactmessage_pkey')
    )
    ...
    op.create_table('portfolio_blogpost',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    ...
    sa.PrimaryKeyConstraint('id', name='portfolio_blogpost_pkey')
    )
    ...
    sa.Column('github_link', sa.VARCHAR(length=200), autoincrement=False, nullable=True),
    sa.Column('demo_link', sa.VARCHAR(length=200), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='portfolio_project_pkey')
    )
    ...
    op.create_table('portfolio_skill',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('badge', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('category', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='portfolio_skill_pkey')
    )
    # ### end Alembic commands ###
